   ...
   /* @Override
    ...
    public class SinchServiceInterface extends Binder {
        ...
        public boolean isStarted() {
            return VoiceService.this.isStarted();
        }
    ...
    private class SinchCallClientListener implements CallClientListener {
        ...
        public void onIncomingCall(CallClient callClient, Call call) {
            ...
            Intent intent = new Intent(VoiceService.this, IncomingCallScreenActivity.class);
    ...
    private String  getname(){
        ...
        SharedPreferences prefs = getApplicationContext().getSharedPreferences("users", Context.MODE_PRIVATE);
